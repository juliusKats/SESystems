...
<script type="text/javascript">
  ...
  <link rel="stylesheet" href="{{ asset('system/plugins/fontawesome-free/css/all.min.css')}}">
   <!-- Ekko Lightbox -->
  <link rel="stylesheet" href="{{ asset('system/plugins/ekko-lightbox/ekko-lightbox.css')}}">
<!-- fullCalendar -->
  ...
  <link rel="stylesheet" href="{{ asset('system/plugins/daterangepicker/daterangepicker.css')}}">
   <!-- Select2 -->
  <link rel="stylesheet" href="{{ asset('system/plugins/select2/css/select2.min.css')}}">
  <link rel="stylesheet" href="{{ asset('system/plugins/select2-bootstrap4-theme/select2-bootstrap4.min.css')}}">
