        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
             ...
             <div class="image">
                ...
                @if (Auth::user()->profile_photo_path)
                    <img style="width:70px;height:70px" class="direct-chat-img" src="{{ url('storage/profile/' . Auth()->user()->profile_photo_path) }}">
                @else
                    <img style="width:70px;height:70px" class="direct-chat-img" src="{{ asset('system/Default/defaultuser.jpg') }}">
                @endif

            </div>
            <div class="info">
                <a href="#" class="d-block">{{ Auth::user()->sname}} {{Auth::user()->fname}} {{ Auth::user()->oname }}</a>
            </div>
            @endauth
        </div>
