                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <select id="VNameSelect" name="votecode" class="select2 form-control" required>
                                    ...
                                    @foreach ($votes as $item)
                                        <option value="{{ $item->id }}">{{ $item->votename }}-{{ $item->votename }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                        ...
                                                                        @foreach ($carders as $carder)
                                                                            <i class="fa fa-check-circle text-success"></i>&nbsp;&nbsp;<span class="text-capitalize">{{ $carder }}<br></span>
                                                                        @endforeach
                                                                ...
                                                                <td>
                                                                    <div class="dropdown mt-1 btn-sm">
                                                                        ...
                                                                        <div class="dropdown-menu">
                                                                                <a target="_blank" href="{{ route('job.description.preview',$item->id, $finalPDF) }}"
