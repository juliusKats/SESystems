 ...
 <!-- jQuery -->
  ...
  <script src="{{ asset('system/frontEnd/vendor/php-email-form/validate.js')}}"></script>
  <script src="{{ asset('system/frontEnd/vendor/aos/aos.js')}}"></script>
  <script src="{{ asset('system/frontEnd/vendor/glightbox/js/glightbox.min.js')}}"></script>
  <script src="{{ asset('system/frontEnd/vendor/swiper/swiper-bundle.min.js')}}"></script>
