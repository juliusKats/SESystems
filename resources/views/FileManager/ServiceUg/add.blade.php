...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">UPLOAD SERVICE UGANDA DOCUMENTS</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('su.file.list') }}">Establishment</a></li>
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" enctype="multipart/form-data" action="{{ route('su.file.store') }}">
                        @csrf
                        <div class="row mb-1">
                            <div class="col-md-6">
                                <div class="form-group mb-1">
                                    <label>Service Centers</label><br>
                                    <select id="entity" multiple
                                        class="select2 form-control  @error('entity') is-invalid @enderror " required
                                        name="entity[]">
                                        @foreach ($entities as $item)
                                            <option value="{{$item->centerName}}">{{ Str::upper($item->centerName)}}</span></option>
                                        @endforeach
                                    </select>
                                    @error('entity')
